...
class PDF(FPDF):
    def header(self):
        ...
        self.cell(80)
        self.cell(30, 10, 'Fraction Multiplication Worksheet', align='C')
        self.ln(20)
...
def generate_fraction_multiplication_worksheet(num_problems=10, include_answer_key=False, output_path="fraction_multiplication.pdf"):
    pdf = PDF()
    pdf.alias_nb_pages()
    ...
    pdf_path = os.path.join(output_dir, 'fraction_multiplication.pdf')
    #pdf.output(pdf_path)
    pdf.output(output_path)
    
# To generate a PDF
#generate_fraction_multiplication_worksheet(include_answer_key=True)