...
class PDF(FPDF):
    def header(self):
        ...
        self.cell(80)
        self.cell(30, 10, 'Basic Subtraction Worksheet', align='C')
        self.ln(30)
...
def generate_random_problems(num_problems, min_value=1, max_value=20):
    """Generates random subtraction problems and their solutions."""
    problems = []
    solutions = []
...
def generate_subtraction_worksheet(num_problems=10, include_answer_key=False, output_path="basic_subtraction.pdf"):
    pdf = PDF()
    pdf.alias_nb_pages()
    pdf.add_page()
