...
class PDF(FPDF):
    def header(self):
        ...
        self.cell(80)
        self.cell(30, 10, 'Fraction Subtraction Worksheet', align='C')
        self.ln(20)
...
def generate_fraction_subtraction_worksheet(num_problems=10, include_answer_key=False, output_path="fraction_subtraction.pdf"):
    pdf = PDF()
    pdf.alias_nb_pages()
